...
import footer from '../../Images/photo_2022-05-23_16-20-55.jpg'
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer style={{
            ...
            backgroundSize:'cover'}}
             class="footer p-10 bg-base-200 text-base-content text-white">
  <div>
...
<footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div class="items-center grid-flow-col">
    ...
    <p>KHANTOOLS Industries Ltd. <br/>Copyright © 2022 - All right reserved by Khan Tools</p>
  </div> 
